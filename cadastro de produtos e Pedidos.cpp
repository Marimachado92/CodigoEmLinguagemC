/* 
   Fun??o: Permitir o cadastro de produtos e Pedidos
...
// DECLARACOES DE FUN??ES DE TELA E AMBIENTE
...
// DECLARA??ES DE FUN??ES DE SERVI?O
char menu();
void despedida();
...
char menu()
{
	...
	color(colorTitle);
	clear(1, 1, 3, 80);
	say(2, 0, "PEDIDO DE PRODUTO - LOGICA DA PROGRAMACAO");
...
// funcao executada antes de finalizar o programa que informa a contagem de uso de cada opcao do menu
void despedida()
{
	system("cls");
...
/////////////////////////////////////////////////////////////////////////////////////////////
//FUN??ES DE TRATAMENTO DE ARQUIVOS
/////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////
//FUN??ES DE PRAPARA??O DE TELA E AMBIENTE
/////////////////////////////////////////////////////////////////////////////////////////////
...
// simula um campo de entrada de dados com a informa??o fornecedida sem dar foco
void fakeGet(int l, int c, char msg[], int size)
{
...
// simula um campo de entrada de dados do tipo int com a informa??o fornecedida sem dar foco
void fakeGet(int l, int c, int valor, char fmt[], int size)
{
	WORD _cor = color(colorGet);
	clear(l, c, l, c+size-1);
...
// simula um campo de entrada de dados do tipo float com a informa??o fornecedida sem dar foco
void fakeGet(int l, int c, float valor, char fmt[], int size)
{
	WORD _cor = color(colorGet);
	clear(l, c, l, c+size-1);
...
// realiza a entrada de uma informa??o texto
void getTexto(int l, int c, char* campo, int size)
{
...
// realiza a entrada de uma informa??o tipo int
void getInt(int l, int c, int* campo, int size)
{
	WORD cor = color(colorGet);
	clear(l, c, l, c+size-1);
...
// realiza a entrada de uma informa??o tipo float
void getFloat(int l, int c, float* campo, int size)
{
	WORD cor = color(colorGet);
	clear(l, c, l, c+size-1);
...
// solicita uma confirma??o cuja resposta deva ser S/N, retornando um boolean referente a resposta (sim=true)
bool confirm(char mens[])
{
	char msgFinal [256];
